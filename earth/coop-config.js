...
(function () {
    ...
    const LABELS = {
        ...
        'TIER_SLUG_SATELLITE': 'Motifs Satellite', 'TIER_SLUG_CONSTELLATION': 'Motifs Constellation',
        'TIER_SLUG_LABO': 'Motifs Labo/R&D', 'TIER_SLUG_CLOUD': 'Motifs Cloud/Membre',
    ...
    const SECTIONS = [
        ...
        { title: 'Routage Tiers OC', icon: '🔀', keys: ['TIER_SLUG_SATELLITE', 'TIER_SLUG_CONSTELLATION', 'TIER_SLUG_LABO', 'TIER_SLUG_CLOUD'] },
    ...
    const DEFAULT_CONFIG = {
        ...
        "_comment_tiers": "=== TIER SLUG ROUTING ===",
